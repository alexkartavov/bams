...
export const environment = {
  ...
  merchantDetails: {
    detailsGetUrl:
      'https://bams-cep-ist-' +
      ENV +
      '-ue-aks.eastus.cloudapp.azure.com/core/api/v1/cep-support/merchants/{merchantId}',
    statementsGetUrl:
      'https://bams-cep-ist-' +
      ENV +
  ...
  reports: {
    boUrl:
      'https://bams-cep-franchise-' +
      ENV +
      '-ue-fa.azurewebsites.net/api/postBoCsv/a6986845-b4fa-4c29-a912-57696d75ab62?code=Zlz0Hn1mpKFrIsE0B/xOZPYgb2pxkXqHFa61DBJjN29JiKLNxx27Ew=='
  }
};
